                    ...
                    <main>
                        ...
                        <c:forEach var="friend" items="${friends}">
                            <div class="post mb-4 d-flex align-items-center" style="overflow-wrap: break-word">
                                <a href="#" class="user-link" data-user-id="${friend.user_id}">
                                    <img src="${friend.profile_pic}" alt="avatar picture" class="img-thumbnail mr-3" style="width: 50px; height: 50px; object-fit: cover;">
                                </a>
                                <a href="#" class="user-link" data-user-id="${friend.user_id}" style="margin-left: 5px">${friend.first_name} ${friend.last_name}</a>
                            </div>
                        </c:forEach>
                    </main>
                </div>
                <div class="right-section col-10">
        ...
        <script>
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (messages) {
                                                ...
                                                messages.forEach(function (message) {
                                                    messageContainer.append('<p>' + message.message + '</p>');
                                                });
                                            },
                                            error: function () {
                                    ...
                                    $('#message-form').on('submit', function (e) {
                                        ...
                                        if (messageInput !== '') {
                                            ...
                                            $('#message-container').append('<p class="my-message">' + messageInput + '</p>');
