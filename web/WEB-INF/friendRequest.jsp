        ...
        <div class="friend-request-card">
            ...
            <div class="action-buttons">
                <form action="friendRequestServlet" method="post">
                    ...
                    <button name="action" value="acceptFriend" type="submit" class="accept-btn">Accept</button>
                </form>
                <form action="friendRequestServlet" method="post">
                    <input type="hidden" name="userRequest" value="${splitRequest[0]}">
                    <button name="action" value="rejectFriend" type="submit" class="reject-btn">Reject</button>
                </form>
            </div>
        </div>
    </c:forEach>
