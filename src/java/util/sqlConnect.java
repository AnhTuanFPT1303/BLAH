...
public class sqlConnect {
    ...
    private String deviceName = "DESKTOP-T4UL83C";
    private String driverClass = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
    private String sqlUrl = "jdbc:sqlserver://DESKTOP-T4UL83C;databaseName=Blah;encrypt=false;trustServerCertificate=false";
